...
class Controls {
  ...
  constructor(camera, canvas) {
    ...
    // me, added mouse wheel zoom control
  ...
  onMouseWheel(event) {
    const delta = Math.sign(event.deltaY); // Detect scroll direction (positive/negative)
    const scrollSpeed = 1; // Adjust this value for desired scroll speed
    this.dolly(-delta * scrollSpeed);
  }
